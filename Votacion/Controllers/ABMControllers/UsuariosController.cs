...
namespace Votacion.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        {
            var dalContext = _context.Usuario.Include(u => u.Mesa);
        ...
        {
            ViewData["MesaID"] = new SelectList(_context.Mesa, "MesaID", "Numero");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioID,CI,Nombres,Apellidos,FechaNacimiento,Edad,MesaID")] Usuario usuario)
        {
